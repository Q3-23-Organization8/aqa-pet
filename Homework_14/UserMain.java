...
public class UserMain {
    public static List<User> main(List<User> args) {
    ...
    public static boolean hasUsersWithSOrA(List<User> users, String letter) {
        return users.stream()
                .anyMatch(u -> u.getSecondName().startsWith(letter.toUpperCase()));
    }

    public static boolean areAllUsersOlderThan18(List<User> users) {
        return users.stream()
                .allMatch(u -> u.getAge() > 18);
    }
}
